...
public class GradusMoving : MonoBehaviour
{
    ...
    float maxY = 838; // верхняя граница в которую уприрается объект, чтобы её узнать нужно объект вытащить за канвас и посмотреть там, внутри канваса он даёт не те координаты какого то хуя

    float minY = 314; // догадайся блять
