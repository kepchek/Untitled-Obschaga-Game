...
public class GradusMoving : MonoBehaviour
{
    ...
    float maxY = 710; // верхняя граница в которую уприрается объект, чтобы её узнать нужно объект вытащить за канвас и посмотреть там, внутри канваса он даёт не те координаты какого то хуя
